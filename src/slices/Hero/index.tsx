...
const Hero = ({ slice }: HeroProps): JSX.Element => {
  ...
  return (
    <Bounded
      ...
      className="bg-yellow-300 relative h-dvh overflow-hidden text-red-800 bg-texture"
    >
      <div className="absolute inset-0 flex items-center pt-20">
        <WideLogo className="w-full text-red-500 hidden opacity-20 mix-blend-multiply lg:block" />
        <TallLogo className="w-full text-red-500 opacity-20 mix-blend-multiply lg:hidden" />
      </div>
